...
{
            "scene_id": "2",
            "visual_description": "Alice is floating slowly down a deep, dark well, surrounded by floating shelves lined with books, cupboards, and various odd items. Some jars are visible, one marked 'ORANGE MARMALADE,' and Alice’s face shows a mix of wonder and contemplation. Her hair floats around her face as she drifts deeper into the darkness.",
            "setting": "A dark, endless well with floating shelves and cupboards",
            "characters_present": [
                "Alice"
            ],
            "mood": "dreamlike"
...
Character portraits (JSON):
{
    ...
    "character_appearance_anchor": "A young girl with shoulder-length light brown hair, wearing a simple knee-length blue dress without additional layers or accessories.",
    "notes": [
...
- If character_appearance_anchor is present, it MUST be included verbatim in the image prompt and takes precedence over all other character description fields.
