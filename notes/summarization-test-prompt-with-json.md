...
- Example JSON format:
{
  ...
  "scenes": [
    {
      "scene_id": "1",
      "visual_description": "A tall man in a green cloak enters a dimly lit tavern, tipping his hat.",
      "setting": "Dimly lit tavern with wooden tables and a stone fireplace",
      "characters_present": ["Tall man in green cloak", "bartender", "patrons"],
      "mood": "mysterious"
    }
  ]
}